...
const properties = [
  ...
  {
    id: 2, title: 'Apartamento frente al mar', description: 'Espectacular Apartamento con vista al mar. Sala-comedor, cocina abierta, 2 recámaras con baño completo cada una. Amenidades: alberca, gimnasio, área de asadores y seguridad 24hrs.', price: 4500000, type: 'apartment', operation: 'sale', bedrooms: 2, bathrooms: 2, area: 120, location: 'Cancún, QRoo', images: ['https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800'], featured: 1, created_at: now, updated_at: now,
  },
  {
